              ...
              <div>
                ...
                <p className="mt-4 text-sm leading-7 text-[#ddd2c0] sm:text-base">
                  {dictionary.formDescription ||
                    "Complétez le formulaire sécurisé, joignez les documents demandés et validez l’anti-bot avant l’envoi."}
                </p>
              </div>

              <div className="space-y-4 rounded-[28px] border border-white/10 bg-white/5 p-5">
                {[
                  dictionary.personalPassportRequired ||
                    "Passeport du joueur obligatoire.",
                  dictionary.companionValidationError ||
                    "Chaque accompagnant doit avoir un nom complet et un passeport.",
                  dictionary.emailInvalid ||
                    "L’adresse email doit être valide.",
                ].map((item) => (
                  <div
                    key={item}
                    className="flex gap-3 text-sm leading-7 text-[#efe6d8]"
                  >
